...
export function formatYearMonth(yearMonth) {
  if (!yearMonth) return ""
  const parsed = moment(yearMonth, ["YYYY-MM", "YYYY-MM-DD"], true)
...
// in helper you will get the mutiple function helper likewise as it is explained beriflt on the a top of each so go throught
