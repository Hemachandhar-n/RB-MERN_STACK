        ...
        <div className={landingPageStyles.container}>
            ...
            <header className={landingPageStyles.header}>
                <div className={landingPageStyles.headerContainer}>
                    {/* Logo */}
                    <div className={`${landingPageStyles.logoContainer} min-w-0 flex-1`}>
                        <div className={landingPageStyles.logoIcon}>
                            <LayoutTemplate className={landingPageStyles.logoIconInner} />
                        </div>
                        <span className={`${landingPageStyles.logoText} truncate`}>
                            ResumeMachines
                        </span>
                    </div>
                    ...
                    <div className="flex items-center gap-3 shrink-0">
                        ...
                        <div className="hidden md:flex items-center justify-center">
                            {user ? (
                                ...
                                <button
                                    className={`${landingPageStyles.desktopAuthButton} whitespace-nowrap`}
                            ...
                            <div className={landingPageStyles.ctaButtons}>
                                ...
                                >
                                    ...
                                    <span className={landingPageStyles.primaryButtonContent}>
                                        Start Building
                                        <ArrowRight className={landingPageStyles.primaryButtonIcon} size={15} />
                                    </span>
                                </button>
                            ...
                            <div className={landingPageStyles.statsContainer}>
                                {stats.map((stat, idx) => (
                                    <div className={landingPageStyles.statItem} key={idx}>
                                        <div className={`${landingPageStyles.statNumber} bg-linear-to-r ${stat.gradient}`}>
                                            {stat.value}
                                        </div>
                                ...
                                >
                                    ...
                                    <defs>
                                        <linearGradient id="bgGradient" x1="0%" y1="0%" x2="100%" y2="100%">
                                            <stop offset="0%" stopColor="#9b5ea8" />
                                            <stop offset="100%" stopColor="#d946ef" />
                                        </linearGradient>
                                        <linearGradient id="cardGradient" x1="0%" y1="0%" x2="100%" y2="100%">
                                            <stop offset="0%" stopColor="#5fcfde" />
                                            <stop offset="100%" stopColor="#7d3b87" />
                                        </linearGradient>
                                    </defs>
                        ...
                        <div className={landingPageStyles.featuresGrid}>
                            {features.map((feature, index) => (
                                <div key={index} className={landingPageStyles.featureCard}>
                                    <div className={`${landingPageStyles.featureCardHover} ${feature.bg}`}></div>
                        ...
                        <div className={landingPageStyles.ctaCard}>
                            ...
                            <div className={landingPageStyles.ctaCardContent}>
                                ...
                                <p className={landingPageStyles.ctaDescription}>
                                    Design a professional resume and land your next opportunity today
                                </p>
            ...
            <footer className={landingPageStyles.footer}>
                <div className={landingPageStyles.footerContainer}>
                    <p className={landingPageStyles.footerText}>
                        ...
                        {' '}by{' '}
                        <a 
                            href="https://github.com/Hemachandhar-n" 
                            target="_blank" 
