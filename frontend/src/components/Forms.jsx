...
// this is  how data fill in edoot resume in the input type
// here i will fill the data in the input type and then i will send the data to the backend and then i will show the data in the resume section
